...
public class MbtoolDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Boolean>> ME_AUTOCRAFTING = register("me_autocrafting", builder -> builder.persistent(com.mojang.serialization.Codec.BOOL));
